...
var (
	...
	ErrInvalidInflationRecipient    = sdkErrors.Register(DefaultCodespace, 5, "invalid inflation recipient")
	ErrInvalidInflationDistribution = sdkErrors.Register(DefaultCodespace, 6, "invalid inflation distribution")
)
