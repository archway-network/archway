...
// func (i increaseBlockNumberBy) Do(app *app.ArchwayApp, ctx sdk.Context) (sdk.Context, error) {
...
// func (i increaseBlockTimeBy) Do(_ *app.ArchwayApp, ctx sdk.Context) (sdk.Context, error) {
...
// func (s setBlockTime) Do(_ *app.ArchwayApp, ctx sdk.Context) (sdk.Context, error) {
...
// func (s setBlockNumber) Do(_ *app.ArchwayApp, ctx sdk.Context) (sdk.Context, error) {
...
// // func (m moveToNextBlock) Do(app *app.ArchwayApp, ctx sdk.Context) (sdk.Context, error) {
...
// // func (m moveToNextBlockWithDuration) Do(app *app.ArchwayApp, ctx sdk.Context) (sdk.Context, error) {
...
// // func (m moveToNextBlockWithTime) Do(app *app.ArchwayApp, ctx sdk.Context) (sdk.Context, error) {
// // 	app.EndBlock(types.RequestEndBlock{Height: ctx.BlockHeight()})
// // 	app.Commit()
