...
type MsgRequestCallback struct {
	...
	CallbackHeight uint64 `protobuf:"varint,4,opt,name=callback_height,json=callbackHeight,proto3" json:"callback_height,omitempty"`
...
func (m *MsgRequestCallback) GetCallbackHeight() uint64 {
	if m != nil {
...
type MsgCancelCallback struct {
	...
	CallbackHeight uint64 `protobuf:"varint,3,opt,name=callback_height,json=callbackHeight,proto3" json:"callback_height,omitempty"`
}
...
func (m *MsgCancelCallback) GetCallbackHeight() uint64 {
	if m != nil {
		return m.CallbackHeight
	}
	return 0
...
type MsgCancelCallbackResponse struct {
	...
	Refund []types.Coin `protobuf:"bytes,1,rep,name=refund,proto3" json:"refund"`
}
...
var fileDescriptor_d9a16d5bd27202f4 = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CallbackHeight |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *MsgCancelCallbackResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Refund = append(m.Refund, types.Coin{})
