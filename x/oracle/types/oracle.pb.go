...
type DatedPrice struct {
	...
	CreationHeight int64 `protobuf:"varint,2,opt,name=creation_height,json=creationHeight,proto3" json:"creation_height,omitempty" yaml:"creation_height"`
	// creation_time_unix_ms defines the block time in milliseconds since unix epoch,
	// when price record was created
	CreationTimeUnixMs uint64 `protobuf:"varint,3,opt,name=creation_time_unix_ms,json=creationTimeUnixMs,proto3" json:"creation_time_unix_ms,omitempty" yaml:"creation_time_unix_ms"`
}
...
func (m *DatedPrice) GetCreationHeight() int64 {
	if m != nil {
...
func (m *DatedPrice) GetCreationTimeUnixMs() uint64 {
	if m != nil {
		return m.CreationTimeUnixMs
	}
	return 0
}
...
var fileDescriptor_ceb632d7c2facf1a = []byte{
	...
	,
}
...
func (m *DatedPrice) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.CreationTimeUnixMs != 0 {
		i = encodeVarintOracle(dAtA, i, uint64(m.CreationTimeUnixMs))
		i--
		dAtA[i] = 0x18
	}
	if m.CreationHeight != 0 {
		i = encodeVarintOracle(dAtA, i, uint64(m.CreationHeight))
		i--
		dAtA[i] = 0x10
	}
	{
...
func (m *DatedPrice) Size() (n int) {
	...
	n += 1 + l + sovOracle(uint64(l))
	if m.CreationHeight != 0 {
		n += 1 + sovOracle(uint64(m.CreationHeight))
	}
	if m.CreationTimeUnixMs != 0 {
		n += 1 + sovOracle(uint64(m.CreationTimeUnixMs))
	}
	return n
}
...
func (m *DatedPrice) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CreationTimeUnixMs", wireType)
			}
			m.CreationTimeUnixMs = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowOracle
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CreationTimeUnixMs |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
