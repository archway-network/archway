...
import (
	...
	// sudokeeper "github.com/archway-network/archway/x/sudo/keeper"
...
func CreateTestFixture(t *testing.T) TestFixture {
	...
	accountKeeper := authkeeper.NewAccountKeeper(
		...
		maccPerms,
		authcodec.NewBech32Codec(appconst.Bech32PrefixAccAddr),
		appconst.Bech32PrefixAccAddr,
	...
	stakingKeeper := stakingkeeper.NewKeeper(
		...
		bankKeeper,
		authtypes.NewModuleAddress(govtypes.ModuleName).String(),
		authcodec.NewBech32Codec(appconst.Bech32PrefixValAddr),
		authcodec.NewBech32Codec(appconst.Bech32PrefixConsAddr),
	)
