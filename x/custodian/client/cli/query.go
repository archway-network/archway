...
func CmdInterchainAccountCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example: "archway query custodian interchain-account archway14k24jzduc365kywrsvf5ujz4ya6mwymy8vq4q connection-0 1",
...
func CmdQueryParams() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "params",
		Short: "fetches the parameters of the custodian module",
		Long:  "fetches the parameters of the custodian module",
		Args:  cobra.NoArgs,
		RunE: func(cmd *cobra.Command, args []string) error {
