...
func (s *subspace) SetParamSet(ctx sdk.Context, paramset paramsTypes.ParamSet) {
	...
	s.boolFlagMaps[string(gastracker.ParamsKeyDappInflationRewards)] = params.GasDappInflationRewardsSwitch
	...
	s.uint64FlagMaps[string(gastracker.ParamsKeyGasRebatePercentage)] = params.GasRebatePercentage
