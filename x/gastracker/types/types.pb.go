...
type ContractGasTracking struct {
	...
	VmGasConsumed  uint64            `protobuf:"varint,2,opt,name=vm_gas_consumed,json=vmGasConsumed,proto3" json:"vm_gas_consumed,omitempty"`
	SdkGasConsumed uint64            `protobuf:"varint,3,opt,name=sdk_gas_consumed,json=sdkGasConsumed,proto3" json:"sdk_gas_consumed,omitempty"`
...
func (m *ContractGasTracking) GetVmGasConsumed() uint64 {
	if m != nil {
		return m.VmGasConsumed
	}
	return 0
}

func (m *ContractGasTracking) GetSdkGasConsumed() uint64 {
	if m != nil {
		return m.SdkGasConsumed
	}
	return 0
}
...
var fileDescriptor_ef6eeaf5a864e490 = []byte{
	...
	,
}
...
func (m *ContractGasTracking) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.SdkGasConsumed != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.SdkGasConsumed))
		i--
		dAtA[i] = 0x18
	}
	if m.VmGasConsumed != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.VmGasConsumed))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Address) > 0 {
...
func (m *ContractGasTracking) Size() (n int) {
	...
	if m.VmGasConsumed != 0 {
		n += 1 + sovTypes(uint64(m.VmGasConsumed))
	}
	if m.SdkGasConsumed != 0 {
		n += 1 + sovTypes(uint64(m.SdkGasConsumed))
	}
	if m.Operation != 0 {
...
func (m *ContractGasTracking) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field VmGasConsumed", wireType)
			}
			m.VmGasConsumed = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.VmGasConsumed |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SdkGasConsumed", wireType)
			}
			m.SdkGasConsumed = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SdkGasConsumed |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
