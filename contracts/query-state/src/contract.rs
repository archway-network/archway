...
mod tests {
    use super::*;
    use cosmwasm_std::testing::{MockApi, MockStorage,MockQuerier ,mock_dependencies, mock_env, mock_info,MOCK_CONTRACT_ADDR};
    ...
    #[test]
    fn increment() {
        let mut deps = mock_dependencies_with_custom_querier(&coins(2, "token"));
