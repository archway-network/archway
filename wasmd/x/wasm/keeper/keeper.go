...
type Keeper struct {
	...
	gasConsumptionHooks []GasConsumptionHook
}
...
func (k Keeper) instantiate(ctx sdk.Context, codeID uint64, creator, admin sdk.AccAddress, initMsg []byte, label string, deposit sdk.Coins, authZ AuthorizationPolicy) (sdk.AccAddress, []byte, error) {
	...
	k.consumeGas(ctx, gasUsed, GasConsumptionContextInstantiate, creator, contractAddress)
	if err != nil {
...
func (k Keeper) execute(ctx sdk.Context, contractAddress sdk.AccAddress, caller sdk.AccAddress, msg []byte, coins sdk.Coins) (*sdk.Result, error) {
	...
	k.consumeGas(ctx, gasUsed, GasConsumptionContextExecute, caller, contractAddress)
	if execErr != nil {
...
func (k Keeper) migrate(ctx sdk.Context, contractAddress sdk.AccAddress, caller sdk.AccAddress, newCodeID uint64, msg []byte, authZ AuthorizationPolicy) (*sdk.Result, error) {
	...
	k.consumeGas(ctx, gasUsed, GasConsumptionContextMigrate, caller, contractAddress)
	if err != nil {
		return nil, sdkerrors.Wrap(types.ErrMigrationFailed, err.Error())
	}
...
func (k Keeper) Sudo(ctx sdk.Context, contractAddress sdk.AccAddress, msg []byte) (*sdk.Result, error) {
	...
	k.consumeGas(ctx, gasUsed, GasConsumptionContextSudo, nil, contractAddress)
	if execErr != nil {
		return nil, sdkerrors.Wrap(types.ErrExecuteFailed, execErr.Error())
	}
...
func (k Keeper) reply(ctx sdk.Context, contractAddress sdk.AccAddress, reply wasmvmtypes.Reply) (*sdk.Result, error) {
	...
	k.consumeGas(ctx, gasUsed, GasConsumptionContextReply, nil, contractAddress)
	if execErr != nil {
		return nil, sdkerrors.Wrap(types.ErrExecuteFailed, execErr.Error())
	}
...
func (k Keeper) QuerySmart(ctx sdk.Context, contractAddr sdk.AccAddress, req []byte) ([]byte, error) {
	...
	k.consumeGas(ctx, gasUsed, GasConsumptionContextQuerySmart, nil, contractAddr)
	if qErr != nil {
...
func (k Keeper) consumeGas(ctx sdk.Context, gas uint64, consCtx GasConsumptionContext, caller, consumedAt sdk.AccAddress) {
	...
	for _, h := range k.gasConsumptionHooks {
		h.ConsumeGas(ctx, consCtx, caller, consumedAt, gas)
	}
}
